function mobileMenu(){
  ...
  $(document).on("click","#mobile-menu-section .menu-has-children>a", function(){
...
function contentMinHeight() {
  if ($("main").hasClass("content-min-height")) {
    const footerHeight = $(".site-footer").innerHeight();
    const contentHeight = `calc(100vh - ${footerHeight - 100}px )`
    $(".content-min-height").css("min-height", contentHeight);
  }
}
