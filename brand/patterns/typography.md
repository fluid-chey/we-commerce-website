...
| Display Name | CSS font-family | File | Role | Weight |
|---|---|---|---|---|
| FLFont Bold | `flfontbold` | flfontbold.ttf | Taglines, emphasis | 95 |
| NeueHaasDisplay | `NeueHaas` | Inter-VariableFont.ttf (proxy) | Headlines (font-weight: 900) | 90 |
| Inter | `Inter` | Inter-VariableFont.ttf | Body copy (font-weight: 300-400) | 80 |
